...
fun main(){
    ...
    var salario = FloatArray(100)
    var abono = FloatArray(100)
    var count1 = 0
    var count2 = 0
    var total = 0f
    
    println("Projeçao de Gastos com Abono\n============================")

    for (i in 0 until 100){
        
        print("Salario: ")
        salario[i] =readLine()!!.toFloat()
    ...
    println("Salário    - Abono")

    for(i in 0 until count1){

        println("R$ ${salario[i]} -  R$ ${abono[i]}")
    }
    
    println("Foram processados ${count1} colaboradores")
    println("Total gasto com abonos: R$ ${total}")
    println("Valor mínimo pago a ${count2} colaboradores")
    println("Maior valor de abono pago: R$ ${ maior_abono}")
